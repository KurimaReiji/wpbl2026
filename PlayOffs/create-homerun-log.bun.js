import games from "../docs/wpbl2026-playoffs.json";
import { findTeam, getTeams } from "../docs/js/wpbl2026-teams.js";
...
async function main() {
  const outfile = join(import.meta.dirname, `../docs/wpbl2026-playoffs-homeruns.json`);
  ...
  for (const g of Object.values(games)) {
    ...
    const teamsAtGameday = getTeams(date);
    ...
    teams.forEach((t) => {
      t.players.forEach((player) => {
        player.team = findTeam(t.id, teamsAtGameday);
